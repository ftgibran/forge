...
- `prisma.config.ts` handles datasource URL and seed command.
- Seed runs via `tsx prisma/seed.ts`.

### Database
- Docker Compose at repo root: `docker compose up -d` starts PostgreSQL 16 Alpine on port 5432.
